...
get_filename_component(_filename "/home/jetson/catkin_ws/src/navigation/navfn/srv/MakeNavPlan.srv" NAME_WE)
add_custom_target(_navfn_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "navfn" "/home/jetson/catkin_ws/src/navigation/navfn/srv/MakeNavPlan.srv" "geometry_msgs/Point:geometry_msgs/Pose:geometry_msgs/PoseStamped:geometry_msgs/Quaternion:std_msgs/Header"
)

get_filename_component(_filename "/home/jetson/catkin_ws/src/navigation/navfn/srv/SetCostmap.srv" NAME_WE)
add_custom_target(_navfn_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "navfn" "/home/jetson/catkin_ws/src/navigation/navfn/srv/SetCostmap.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/navfn)
  install(CODE "execute_process(COMMAND \"/home/jetson/miniconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/navfn\")")
  # install generated code
  install(
