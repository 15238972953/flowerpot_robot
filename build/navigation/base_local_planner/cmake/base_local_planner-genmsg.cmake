...
set(MSG_I_FLAGS "-Ibase_local_planner:/home/jetson/catkin_ws/src/navigation/base_local_planner/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/jetson/catkin_ws/src/navigation/base_local_planner/msg/Position2DInt.msg" NAME_WE)
add_custom_target(_base_local_planner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "base_local_planner" "/home/jetson/catkin_ws/src/navigation/base_local_planner/msg/Position2DInt.msg" ""
)
...
_generate_msg_cpp(base_local_planner
  "/home/jetson/catkin_ws/src/navigation/base_local_planner/msg/Position2DInt.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/base_local_planner)
  install(CODE "execute_process(COMMAND \"/home/jetson/miniconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/base_local_planner\")")
  # install generated code
  install(
