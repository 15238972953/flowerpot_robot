...
set(MSG_I_FLAGS "-Itracking_pkg:/home/jetson/catkin_ws/src/tracking_pkg/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/jetson/catkin_ws/src/tracking_pkg/msg/track.msg" NAME_WE)
add_custom_target(_tracking_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tracking_pkg" "/home/jetson/catkin_ws/src/tracking_pkg/msg/track.msg" ""
)
...
_generate_msg_cpp(tracking_pkg
  "/home/jetson/catkin_ws/src/tracking_pkg/msg/track.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tracking_pkg)
  install(CODE "execute_process(COMMAND \"/home/jetson/miniconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tracking_pkg\")")
  # install generated code
  install(
