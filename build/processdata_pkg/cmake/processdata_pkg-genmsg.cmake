...
add_custom_target(processdata_pkg_generate_messages ALL)
...
_generate_module_cpp(processdata_pkg
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/processdata_pkg
  "${ALL_GEN_OUTPUT_FILES_cpp}"
)

add_custom_target(processdata_pkg_generate_messages_cpp
...
add_dependencies(processdata_pkg_gencpp processdata_pkg_generate_messages_cpp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS processdata_pkg_generate_messages_cpp)
...
### Generating Module File
_generate_module_eus(processdata_pkg
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/processdata_pkg
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(processdata_pkg_generate_messages_eus
...
add_dependencies(processdata_pkg_geneus processdata_pkg_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS processdata_pkg_generate_messages_eus)
...
### Generating Module File
_generate_module_lisp(processdata_pkg
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/processdata_pkg
  "${ALL_GEN_OUTPUT_FILES_lisp}"
)

add_custom_target(processdata_pkg_generate_messages_lisp
...
add_dependencies(processdata_pkg_genlisp processdata_pkg_generate_messages_lisp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS processdata_pkg_generate_messages_lisp)
...
### Generating Module File
_generate_module_nodejs(processdata_pkg
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/processdata_pkg
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(processdata_pkg_generate_messages_nodejs
...
add_dependencies(processdata_pkg_gennodejs processdata_pkg_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS processdata_pkg_generate_messages_nodejs)
...
### Generating Module File
_generate_module_py(processdata_pkg
  ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/processdata_pkg
  "${ALL_GEN_OUTPUT_FILES_py}"
)

add_custom_target(processdata_pkg_generate_messages_py
...
add_dependencies(processdata_pkg_genpy processdata_pkg_generate_messages_py)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS processdata_pkg_generate_messages_py)



if(gencpp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/processdata_pkg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/processdata_pkg
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/processdata_pkg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/processdata_pkg
...
if(genlisp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/processdata_pkg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/processdata_pkg
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/processdata_pkg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/processdata_pkg
