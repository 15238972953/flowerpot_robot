...
(cl:defmethod cl:initialize-instance :after ((m <coordinate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'coordinate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yolo11_pkg-msg:<coordinate> is deprecated: use yolo11_pkg-msg:coordinate instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <coordinate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo11_pkg-msg:x-val is deprecated.  Use yolo11_pkg-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <coordinate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo11_pkg-msg:y-val is deprecated.  Use yolo11_pkg-msg:y instead.")
  (y m))
