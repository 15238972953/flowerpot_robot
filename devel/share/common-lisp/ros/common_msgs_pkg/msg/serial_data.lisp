...
(cl:defmethod cl:initialize-instance :after ((m <serial_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'serial_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name common_msgs_pkg-msg:<serial_data> is deprecated: use common_msgs_pkg-msg:serial_data instead.")))

(cl:ensure-generic-function 'PWM_Left-val :lambda-list '(m))
(cl:defmethod PWM_Left-val ((m <serial_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_msgs_pkg-msg:PWM_Left-val is deprecated.  Use common_msgs_pkg-msg:PWM_Left instead.")
  (PWM_Left m))

(cl:ensure-generic-function 'PWM_Right-val :lambda-list '(m))
(cl:defmethod PWM_Right-val ((m <serial_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_msgs_pkg-msg:PWM_Right-val is deprecated.  Use common_msgs_pkg-msg:PWM_Right instead.")
  (PWM_Right m))
