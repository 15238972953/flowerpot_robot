...
(cl:defmethod cl:initialize-instance :after ((m <radar>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'radar)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name radar_pkg-msg:<radar> is deprecated: use radar_pkg-msg:radar instead.")))

(cl:ensure-generic-function 'n-val :lambda-list '(m))
(cl:defmethod n-val ((m <radar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader radar_pkg-msg:n-val is deprecated.  Use radar_pkg-msg:n instead.")
  (n m))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <radar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader radar_pkg-msg:r-val is deprecated.  Use radar_pkg-msg:r instead.")
  (r m))

(cl:ensure-generic-function 'phi-val :lambda-list '(m))
(cl:defmethod phi-val ((m <radar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader radar_pkg-msg:phi-val is deprecated.  Use radar_pkg-msg:phi instead.")
  (phi m))
