...
(cl:in-package tracking_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <track>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'track)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tracking_pkg-msg:<track> is deprecated: use tracking_pkg-msg:track instead.")))

(cl:ensure-generic-function 'line-val :lambda-list '(m))
(cl:defmethod line-val ((m <track>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracking_pkg-msg:line-val is deprecated.  Use tracking_pkg-msg:line instead.")
  (line m))
